            ...
            if (done == 0){
              var loadingGraph = setInterval(function(){
                if(done == 1){
                  ...
                  $('body').prepend('<div id="networkTip"  class="footer zoomPopUp zoomPopUpHeight"><p>Dear tester. Be patient with this view. It will take <span class="">~30 seconds</span> to load</p><div class="close"><img src="./css/icons/close.svg"></div></div>')
                  setTimeout(function(){
                    runNetwork()
